...
function updateUserUI() {
  ...
  // Eliminar enlace de Inventario si ya existe (para evitar duplicados)
  ...
  if (currentUser) {
    ...
    if (isAdmin) {
      ...
      // Crear nuevo enlace para Inventario
      ...
      // Insertar antes de "Rastrea tu pedido"
    ...
    // Eliminar logout previo si existe...
